...
trait CGenAVX512012 extends CGenIntrinsics {
  ...
  override def emitNode(sym: Sym[Any], rhs: Def[Any]) = rhs match {
    ...
    case iDef@MM_MASK_FPCLASS_PD_MASK(k1, a, imm8) =>
      headers += iDef.header
    ...
    case iDef@MM_MASKZ_CVTTPD_EPI64(k, a) =>
      headers += iDef.header
      emitValDef(sym, s"_mm_maskz_cvttpd_epi64(${quote(k)}, ${quote(a)})")
    case iDef@MM_MASKZ_UNPACKLO_PD(k, a, b) =>
      headers += iDef.header
    ...
    case iDef@MM256_MASKZ_SRA_EPI32(k, a, count) =>
      headers += iDef.header
      emitValDef(sym, s"_mm256_maskz_sra_epi32(${quote(k)}, ${quote(a)}, ${quote(count)})")
    case iDef@MM_MASK_MAX_SS(src, k, a, b) =>
      headers += iDef.header
    ...
    case iDef@MM_MASKZ_EXPAND_PS(k, a) =>
      headers += iDef.header
    ...
    case iDef@MM256_MASK_TEST_EPI16_MASK(k1, a, b) =>
      headers += iDef.header
    ...
    case iDef@MM_MASK_CMPGE_EPU16_MASK(k1, a, b) =>
      headers += iDef.header
    ...
    case iDef@MM256_MASKZ_AND_PS(k, a, b) =>
      headers += iDef.header
      emitValDef(sym, s"_mm256_maskz_and_ps(${quote(k)}, ${quote(a)}, ${quote(b)})")
    case iDef@MM_REDUCE_SS(a, b, imm8) =>
      headers += iDef.header
    ...
    case iDef@MM_MASKZ_EXPANDLOADU_PS(k, mem_addr, mem_addrOffset) =>
      headers += iDef.header
      emitValDef(sym, s"_mm_maskz_expandloadu_ps(${quote(k)}, (void const*) (${quote(mem_addr)  + (if(mem_addrOffset == Const(0)) "" else " + " + quote(mem_addrOffset))}))")
    case iDef@MM_MASK_MULLO_EPI64(src, k, a, b) =>
      headers += iDef.header
    ...
    case iDef@MM256_MASK_RANGE_PD(src, k, a, b, imm8) =>
      headers += iDef.header
    ...
    case iDef@MM_MASKZ_GETMANT_ROUND_SS(k, a, b, interv, sc, rounding) =>
      headers += iDef.header
    ...
    case iDef@MM_MASK_MIN_SD(src, k, a, b) =>
      headers += iDef.header
    ...
    case iDef@MM_SRAV_EPI64(a, count) =>
      headers += iDef.header
    ...
    case iDef@MM512_MASKZ_ALIGNR_EPI8(k, a, b, count) =>
      headers += iDef.header
      emitValDef(sym, s"_mm512_maskz_alignr_epi8(${quote(k)}, ${quote(a)}, ${quote(b)}, ${quote(count)})")
    case iDef@MM512_RANGE_PS(a, b, imm8) =>
      headers += iDef.header
    ...
    case iDef@MM_MASKZ_CONFLICT_EPI64(k, a) =>
      headers += iDef.header
      emitValDef(sym, s"_mm_maskz_conflict_epi64(${quote(k)}, ${quote(a)})")
    case iDef@MM_GETEXP_ROUND_SS(a, b, rounding) =>
      headers += iDef.header
    ...
    case iDef@MM_MASK3_FMADD_PS(a, b, c, k) =>
      headers += iDef.header
    ...
    case iDef@MM512_MASK_SRAI_EPI16(src, k, a, imm8) =>
      headers += iDef.header
    ...
    case iDef@MM_MASKZ_ANDNOT_PS(k, a, b) =>
      headers += iDef.header
      emitValDef(sym, s"_mm_maskz_andnot_ps(${quote(k)}, ${quote(a)}, ${quote(b)})")
    case iDef@MM512_MASKZ_GETMANT_PD(k, a, interv, sc) =>
      headers += iDef.header
    ...
    case iDef@MM512_INSERTI64X4(a, b, imm8) =>
      headers += iDef.header
      emitValDef(sym, s"_mm512_inserti64x4(${quote(a)}, ${quote(b)}, ${quote(imm8)})")
    case iDef@MM_MASKZ_MOVE_SD(k, a, b) =>
      headers += iDef.header
      emitValDef(sym, s"_mm_maskz_move_sd(${quote(k)}, ${quote(a)}, ${quote(b)})")
    case iDef@MM512_PREFETCH_I64GATHER_PS(vindex, base_addr, scale, hint, base_addrOffset) =>
      headers += iDef.header
      stream.println(s"_mm512_prefetch_i64gather_ps(${quote(vindex)}, (void const*) (${quote(base_addr)  + (if(base_addrOffset == Const(0)) "" else " + " + quote(base_addrOffset))}), ${quote(scale)}, ${quote(hint)});")
    case iDef@MM_MASK_FNMADD_ROUND_SS(a, k, b, c, rounding) =>
      headers += iDef.header
      emitValDef(sym, s"_mm_mask_fnmadd_round_ss(${quote(a)}, ${quote(k)}, ${quote(b)}, ${quote(c)}, ${quote(rounding)})")
    case iDef@MM256_MASKZ_CVTTPD_EPI64(k, a) =>
      headers += iDef.header
    ...
    case iDef@MM256_MASKZ_SUB_EPI16(k, a, b) =>
      headers += iDef.header
    ...
    case iDef@MM512_MASK_CVTTPD_EPU64(src, k, a) =>
      headers += iDef.header
    ...
    case iDef@MM_MASK_FNMSUB_SD(a, k, b, c) =>
      headers += iDef.header
      emitValDef(sym, s"_mm_mask_fnmsub_sd(${quote(a)}, ${quote(k)}, ${quote(b)}, ${quote(c)})")
    case iDef@MM_MASKZ_PERMUTEVAR_PS(k, a, b) =>
      headers += iDef.header
      emitValDef(sym, s"_mm_maskz_permutevar_ps(${quote(k)}, ${quote(a)}, ${quote(b)})")
    case iDef@MM_MASK_SLLI_EPI32(src, k, a, imm8) =>
      headers += iDef.header
      emitValDef(sym, s"_mm_mask_slli_epi32(${quote(src)}, ${quote(k)}, ${quote(a)}, ${quote(imm8)})")
    case iDef@MM256_MASK_I64SCATTER_EPI64(base_addr, k, vindex, a, scale, base_addrOffset) =>
      headers += iDef.header
      stream.println(s"_mm256_mask_i64scatter_epi64((void*) (${quote(base_addr)  + (if(base_addrOffset == Const(0)) "" else " + " + quote(base_addrOffset))}), ${quote(k)}, ${quote(vindex)}, ${quote(a)}, ${quote(scale)});")
    case iDef@MM_MASK_DIV_PS(src, k, a, b) =>
      headers += iDef.header
      emitValDef(sym, s"_mm_mask_div_ps(${quote(src)}, ${quote(k)}, ${quote(a)}, ${quote(b)})")
    case iDef@MM_MASKZ_REDUCE_PD(k, a, imm8) =>
      headers += iDef.header
      emitValDef(sym, s"_mm_maskz_reduce_pd(${quote(k)}, ${quote(a)}, ${quote(imm8)})")
    case iDef@MM512_MASKZ_EXP2A23_PD(k, a) =>
      headers += iDef.header
    ...
    case iDef@MM256_MASKZ_FMADDSUB_PS(k, a, b, c) =>
      headers += iDef.header
      emitValDef(sym, s"_mm256_maskz_fmaddsub_ps(${quote(k)}, ${quote(a)}, ${quote(b)}, ${quote(c)})")
    case iDef@MM256_MASKZ_MULHI_EPI16(k, a, b) =>
      headers += iDef.header
      emitValDef(sym, s"_mm256_maskz_mulhi_epi16(${quote(k)}, ${quote(a)}, ${quote(b)})")
    case iDef@MM512_TERNARYLOGIC_EPI64(a, b, c, imm8) =>
      headers += iDef.header
      emitValDef(sym, s"_mm512_ternarylogic_epi64(${quote(a)}, ${quote(b)}, ${quote(c)}, ${quote(imm8)})")
    case iDef@MM512_LOADU_PD(mem_addr, mem_addrOffset) =>
      headers += iDef.header
      emitValDef(sym, s"_mm512_loadu_pd((void const*) (${quote(mem_addr)  + (if(mem_addrOffset == Const(0)) "" else " + " + quote(mem_addrOffset))}))")
    case iDef@MM_SCALEF_ROUND_SD(a, b, rounding) =>
      headers += iDef.header
    ...
    case iDef@MM256_MASKZ_SHUFFLE_EPI8(k, a, b) =>
      headers += iDef.header
    ...
    case iDef@MM256_INSERTF64X2(a, b, imm8) =>
      headers += iDef.header
